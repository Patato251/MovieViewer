...
export interface IMovieCacheClient {
    ...
    changeMaxCache(newSize: number): Observable<string>;
    changeMinCache(newSize: number): Observable<string>;
    checkMinCache(): Observable<string>;
    checkMaxCache(): Observable<string>;
}
...
export class MovieCacheClient implements IMovieCacheClient {
    ...
    changeMaxCache(newSize: number): Observable<string> {
        let url_ = this.baseUrl + "/api/MovieCache/cachemax/{newSize}";
        if (newSize === undefined || newSize === null)
            throw new Error("The parameter 'newSize' must be defined.");
        url_ = url_.replace("{newSize}", encodeURIComponent("" + newSize)); 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processChangeMaxCache(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processChangeMaxCache(<any>response_);
                } catch (e) {
    ...
    protected processChangeMaxCache(response: HttpResponseBase): Observable<string> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    changeMinCache(newSize: number): Observable<string> {
        let url_ = this.baseUrl + "/api/MovieCache/cachemin/{newSize}";
        if (newSize === undefined || newSize === null)
            throw new Error("The parameter 'newSize' must be defined.");
        url_ = url_.replace("{newSize}", encodeURIComponent("" + newSize)); 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processChangeMinCache(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processChangeMinCache(<any>response_);
                } catch (e) {
                    return <Observable<string>><any>_observableThrow(e);
                }
            } else
    ...
    protected processChangeMinCache(response: HttpResponseBase): Observable<string> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    checkMinCache(): Observable<string> {
        let url_ = this.baseUrl + "/api/MovieCache/checkMax";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processCheckMinCache(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCheckMinCache(<any>response_);
                } catch (e) {
                    return <Observable<string>><any>_observableThrow(e);
                }
            } else
    ...
    protected processCheckMinCache(response: HttpResponseBase): Observable<string> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    checkMaxCache(): Observable<string> {
        let url_ = this.baseUrl + "/api/MovieCache/checkMin";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processCheckMaxCache(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCheckMaxCache(<any>response_);
                } catch (e) {
                    return <Observable<string>><any>_observableThrow(e);
                }
            } else
    ...
    protected processCheckMaxCache(response: HttpResponseBase): Observable<string> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
